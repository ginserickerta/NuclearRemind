...
knowledge_per_note  = 5.0      # ★ 2026-07-23 (เจ้าของ) — วิจัยโน้ตเสร็จ = ความรู้ +5 (ใหญ่กว่าอ่าน Codex +2)
                               #   8 โน้ต × 5 = 40 · รวม start 20 + Codex 22 + แล็บรายวัน → Expert(80) ต้องเล่นครบระบบ
...
fuel_need_boost     = 9.0
fuel_need_od        = 12.0
# ★ 2026-07-23 (เจ้าของ) — เปลี่ยนโหมดเตา = การตัดสินใจมีราคา:
#   · เปลี่ยนได้ วันละ 1 ครั้ง (สิทธิ์รีเซ็ตตอนเริ่มวัน)
#   · กดเปลี่ยนโหมดไหน หัก Deuterium ทันทีตามโหมดปลายทาง (Idle 2 · Normal 6 · Boost 9 · OD 12)
#   · Deuterium ไม่พอ = เปลี่ยนไม่ได้ (ก่อนหน้านี้กดเปลี่ยนฟรีไม่จำกัดแม้คลังเป็น 0)
#   · การเผารายวันตอนจบวัน (ตาม fuel_need ของโหมด) ยังทำงานเหมือนเดิม
fuel_need_idle      = 2.0      # ค่าเปลี่ยนเข้าโหมด Idle (Idle ไม่เผารายวัน)
