...
namespace NuclearReMind
{
    ...
    public class PlacementController : MonoBehaviour
    {
        ...
        public void BeginPlacement(BuildingData buildingData)
        {
            ...
            if (ghostRenderer != null)
            {
                ghostRenderer.sprite = buildingData.icon;
        ...
        public void ConfirmPlace()
        {
            ...
            EventManager.RaiseBuildingPlaced(GridManager.Instance.GetCell(currentCell.x, currentCell.y), selectedBuilding);
        ...
        public void CancelPlacement()
        {
            ...
            EventManager.RaisePlacementCancelled();
            EndPlacement();
        }
