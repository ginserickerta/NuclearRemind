...
| **B · บำบัดด้วยสารเภสัชรังสี** | วัสดุแล็บ 200 · ดึง Tritium 20 มาทำยา | รักษาครบ 15 คนใน 1 วัน กลับมาทำงานทันที แต่เสียเชื้อเพลิงที่จะดัน Q |
...
**Q4 · ยิงเป้าที่เซลล์มะเร็ง**  ·  ผู้ถาม: แพทย์ประจำเมือง

**ถาม:** ทำไมการใช้สารเภสัชรังสี (เครื่องสแกน PET/SPECT และยาเฉพาะจุด) ถึงเหมาะกับการจัดการเซลล์เนื้อร้าย?

- **A.** เพราะมันทำให้คนแข็งแรงขึ้นทันทีโดยไม่เกี่ยวกับโรค
- **B.** เพราะมันชี้เป้าและทำลายเฉพาะเซลล์ผิดปกติได้แม่นยำ กระทบเนื้อดีรอบ ๆ น้อย ✓
- **C.** เพราะรังสีฆ่าทุกเซลล์ในร่างกายเท่ากันหมด

**คำอธิบาย:** เครื่องสแกน PET/SPECT ใช้สารรังสีชี้ตำแหน่งเซลล์ผิดปกติ ส่วนยาเฉพาะจุดส่งรังสีไปทำลายเป้าโดยตรง — ความแม่นยำนี้คือเหตุผลที่เทคโนโลยีนิวเคลียร์ช่วยชีวิตคนได้ 🔓 ปลดล็อก Codex "Nuclear Medicine"
...
| **Tritium** | เชื้อเพลิง | Zone B (Phase 4) | ดัน Q ท้ายเตา · ทำยารังสี |
| **Rad-Gear** | อุปกรณ์ | Iron + วิจัย | กันคนป่วย/ตายเมื่อส่งเข้าพื้นที่รังสี |
| **เครื่องสแกน PET/SPECT** | การแพทย์ | โรงพยาบาล + พลังงาน | คัดแยกคนป่วยเนื้อร้าย (วิกฤต 2 · ก) |
| **ยารังสีเฉพาะจุด** | การแพทย์ | แร่เหล็ก 200 + Tritium 20 | รักษาผู้ป่วยหายสนิท (วิกฤต 2 · ข) |
| **เมล็ดพันธุ์ฉายรังสี** | เกษตร | ห้องวิจัย + แร่เหล็ก 250 | เพิ่มผลผลิตอาหารยาว (วิกฤต 3 · ก) |
| **เครื่องฉายโคบอลต์-60** | ถนอมอาหาร | โรงงาน + พลังงาน 300 | ยืดอาหารเน่า → 0% (วิกฤต 3 · ข) |
| **น้ำหล่อเย็นฉุกเฉิน** | ฉุกเฉิน | น้ำสะอาด | ลด HEAT เตาเร่งด่วน (วิกฤต 1 · ค) |
| **★ โล่พลาสมา** | ชิ้นชนะ | CORE TOWER ที่ Q ≥ 1.0 | กางรับพายุรังสี = ชนะเกม |

> **หมายเหตุฟิสิกส์:** Tritium และ Rad-Gear ตอกย้ำว่าฟิวชัน D-T ปล่อยนิวตรอนและมีสารรังสีเข้ามาเกี่ยว — ทำให้คำว่า "สะอาดกว่า" ไม่ใช่ "ไม่มีรังสีเลย" (เชื่อม Q9)
