...
▸ ความคิด: ผมสัญญากับพวกเขาไว้ว่ามันจะดีขึ้น...";
            ...
            DilemmaData foodAftermath)
        {
            ...
            beats.Add(Beat("reactor_preview", StoryTriggerType.OnBuildingStaffed, "ห้องปฏิบัติการ", b =>
            {
                ...
                b.dialoguePre = new[]
                {
                    L(Speaker.Kova, "เห็นหอสูงกลางเมืองไหม เตาฟิวชัน — นั่นแหละงานหลักของนาย", Emotion.Explain),
                    L(Speaker.Kova, "ยังจุดไม่ได้หรอก ไม่มีเชื้อเพลิง แต่พอถึงเวลาจริง ฉันไม่อยากให้นายมัวงงกับปุ่ม", Emotion.Neutral),
                    L(Speaker.InnerVoice, "หอนั่น ทีมเก่าสร้างค้างไว้ครึ่งทาง... ที่เหลือเป็นของผมแล้ว", Emotion.Determined),
                };
            ...
            beats.Add(Beat("crisis_plasma_stability", StoryTriggerType.OnStatThreshold, CrisisSchedule.PlasmaTrigger, b =>
            {
                ...
                b.dialoguePre = new[]
                {
                    ...
                    L(Speaker.Kova, "เตาไม่ได้ร้อนเพราะมันเกลียดนายหรอก ไปที่หอควบคุม ติดคอยล์ให้ครบสองตัวก่อน แล้วค่อยคิดเรื่องเร่ง", Emotion.Neutral),
                    L(Speaker.Kova, "Toroidal ยกเพดานให้ดันแรงขึ้น Poloidal รีดความร้อนทิ้ง — ขาดตัวใดตัวหนึ่ง เตาก็เอาไม่อยู่", Emotion.Explain),
                    L(Speaker.InnerVoice, "คอยล์คู่นี่แหละ... กำแพงเดียวที่กั้นเรากับการหลอมละลาย", Emotion.Thinking),
                    // บทเปิดวิกฤต Kova → Mira → Kova → Mira + Inner Voice
                    L(Speaker.Kova, "ไม่ไหวแล้ว สนามแม่เหล็กเริ่มเอาพลาสมาไม่อยู่ ถ้ามันหลุด เตาละลายทั้งลูก", Emotion.Worried),
                    L(Speaker.Mira, "แล้วคนที่ประจำอยู่หอควบคุมล่ะ", Emotion.Serious),
                    L(Speaker.Kova, "นั่นแหละที่ผมห่วง พวกเขาอยู่ใกล้สุด", Emotion.Worried),
                    L(Speaker.Mira, "งั้นรีบตัดสินใจ ฉันจะไปเตรียมที่พยาบาลไว้ เผื่อไว้ก่อน", Emotion.Determined),
                    L(Speaker.InnerVoice, "เพิ่งตั้งเมืองได้ไม่กี่วัน... เตาก็จะเอาคืนแล้ว", Emotion.Worried),
                };
            ...
            beats.Add(Beat("crisis_radiation_disease", StoryTriggerType.OnStatThreshold, CrisisSchedule.OutbreakTrigger, b =>
            {
                ...
                {
                    L(Speaker.Mira, "หยุดส่งคนลงเหมืองก่อน — ที่ล้มไปสิบห้าคนน่ะ ไม่ใช่หมดแรง เนื้อมันเริ่มโตผิดที่แล้ว", Emotion.Surprised),
                    L(Speaker.Kova, "โตผิดที่... หมายความว่ายังไง", Emotion.Serious),
                    L(Speaker.Mira, "รังสีสะสม Kova ฉันเคยเห็นมาก่อน ปล่อยไว้อีกสามวันมีคนตายแน่", Emotion.Serious),
                    L(Speaker.Kova, "แล้วแก้ยังไง", Emotion.Serious),
                    L(Speaker.Mira, "มีทางอยู่ — แต่ไม่มีทางไหนฟรี เอาคน เอาพลังงาน หรือเอาเวลาไปเสี่ยง เลือกเอา", Emotion.Explain),
                    L(Speaker.InnerVoice, "คนพวกนั้นขุดแร่ให้เมืองมาตลอด... ผมจะหันหลังตอนนี้ไม่ได้", Emotion.Determined),
                };
            ...
            beats.Add(Beat("crisis_food_spoilage", StoryTriggerType.OnStatThreshold, CrisisSchedule.FoodTrigger, b =>
            {
                ...
                {
                    L(Speaker.Dorn, "ผมทำนามาทั้งชีวิต ไม่เคยเห็นข้าวเน่าเร็วขนาดนี้ — สามวันเกลี้ยงยุ้ง", Emotion.Serious),
                    L(Speaker.Kova, "ไม่ใช่ฝีมือนายหรอก Dorn — รังสีพื้นหลังมันสูงผิดปกติ ของถึงเน่าไวขนาดนี้", Emotion.Serious),
                    L(Speaker.Dorn, "แล้วนี่คุณจะให้ผมเอา 'รังสี' ไปยิงใส่ข้าวที่คนต้องกินงั้นเหรอ บ้าไปแล้ว", Emotion.Thinking),
                    L(Speaker.Mira, "ฉายรังสีฆ่าเชื้อ ไม่ได้ทำให้อาหารมีรังสี Dorn คนละเรื่องกัน — มันจะเก็บได้นานขึ้น ไม่ใช่เป็นพิษ", Emotion.Explain),
                    L(Speaker.Dorn, "...ถ้ามันช่วยให้คนไม่อดตาย ผมก็ยอมลองของคุณ แต่ถ้าใครป่วยขึ้นมา ผมเอาเรื่องแน่", Emotion.Serious),
                    L(Speaker.InnerVoice, "คนที่กลัวที่สุด... มักเป็นคนที่แบกปากท้องคนอื่นไว้", Emotion.Thinking),
                };
                b.dialoguePost = new[] // v8.5 บทปิดวิกฤต 3 (กลาง · ใช้ได้ทุกทางเลือก A/B/C) — หลัง outcome ก่อนควิซ #6/#7
                {
                    L(Speaker.Dorn, "ยุ้งข้าวไม่ว่างเปล่าแล้ว... เท่านี้ผมก็หายใจได้อีกหน่อย", Emotion.Proud),
                    L(Speaker.Mira, "เมืองยังมีข้าวกิน ก็ยังมีแรงสู้ต่อ Dorn", Emotion.Happy),
                    L(Speaker.Dorn, "ผมเคยคิดว่าของพวกคุณมันน่ากลัว แต่ที่น่ากลัวกว่าคือคนอดตายทั้งเมือง — คราวนี้ผมเชื่อคุณ", Emotion.Happy),
                    L(Speaker.InnerVoice, "ความกลัวจางลงได้ ถ้าคนเรายอมเข้าใจมันก่อน", Emotion.Happy),
                };
                b.crisis = foodCrisis;
            ...
            beats.Add(Beat("tritium_warning", StoryTriggerType.OnStatThreshold, "core_above_78", b =>
            {
                b.dialoguePre = new[]
                {
                    ...
                    L(Speaker.Kova, "ดิวเทอเรียมพาเรามาได้ไกลถึงตรงนี้ แต่มันดันต่อไม่ไหวแล้ว จากนี้เตาต้องการเชื้อเพลิงอีกตัว ไปเปิด Zone B ซะ", Emotion.Serious),
                    L(Speaker.InnerVoice, "Zone B... โซนที่ทีมเก่าปิดตายไว้ ผมเริ่มเข้าใจแล้วว่าทำไม", Emotion.Thinking),
                };
            ...
            beats.Add(Beat("tritium_teach", StoryTriggerType.OnStatThreshold, "core_above_80", b =>
            {
                ...
                b.dialoguePre = new[]
                {
                    L(Speaker.Kova, "Zone B คือโรงเพาะทริเทียม เอานิวตรอนจากเตายิงใส่ลิเทียม มันก็คายทริเทียมออกมา — เตาเลี้ยงเชื้อเพลิงของตัวเองได้", Emotion.Explain),
                    L(Speaker.Mira, "แต่ทริเทียมมันกัมมันตรังสี จัดคนเข้า Zone B ให้น้อยที่สุด แล้วอย่าลืมชุดกันรังสี — ALARA เหมือนเดิม", Emotion.Explain),
                    L(Speaker.InnerVoice, "เตาที่เลี้ยงเชื้อเพลิงตัวเองได้... นี่แหละที่ทีมเก่าฝันถึง", Emotion.Surprised),
                };
            ...
            beats.Add(Beat("storm_first_light", StoryTriggerType.OnStormApproach, "", b =>
            {
                ...
                {
                    L(Speaker.Kova, "ค่ามันขึ้นเร็วกว่าที่คิด นายมีเวลาน้อยกว่าที่วางไว้", Emotion.Worried),
                    L(Speaker.Mira, "ข้างล่างเริ่มถามกันแล้วว่าจะเป็นยังไง", Emotion.Thinking),
                    L(Speaker.Kova, "ยังไม่ต้องบอกอะไรเขา ยังไม่ถึงเวลา", Emotion.Serious),
                    L(Speaker.Mira, "แล้วเมื่อไหร่ถึงเวลา", Emotion.Thinking),
                    L(Speaker.Kova, "พอ CORE แตะร้อยเมื่อไหร่ ฉันจะบอกเอง", Emotion.Serious),
                    L(Speaker.Kova, "เอาละ วิศวกร ที่เหลือนายจัดการ ฉันจะไปคุมหล่อเย็น", Emotion.Proud),
                    L(Speaker.InnerVoice, "มือผมสั่น... แต่ไม่มีเวลาให้สั่นแล้ว", Emotion.Worried),
                };
        ...
        // overload มีอารมณ์ — ใช้กับ Kova (มี portrait จริง) ให้สีหน้าตรงกับประโยค
        private static DialogueLine L(Speaker speaker, string text, Emotion emotion)
            => new DialogueLine { speaker = speaker, textTH = text, emotion = emotion };
